...
- **DAST:** Explain that ZAP Baseline is **passive** (no active attacks by default), good for CI, and why the app is bound to `0.0.0.0` and reached via `host.docker.internal` / bridge IP.
